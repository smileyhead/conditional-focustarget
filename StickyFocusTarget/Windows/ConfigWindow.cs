...
public class ConfigWindow : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        ImGui.TextUnformatted(Loc.settings_lang_dropdown_label); ImGui.SameLine();
        ...
        string crowdinLink = "https://crowdin.com";
        if (ImGui.Button(Loc.settings_lang_crowdin_button))
            Dalamud.Utility.Util.OpenLink(crowdinLink); //TODO
        if (ImGui.IsItemHovered())
            ImGui.SetTooltip(Loc.settings_lang_crowdin_tooltip.Replace("{crowdinLink}", crowdinLink));
        ...
        ImGui.TextUnformatted("/stickyfocustarget: "); ImGui.SameLine();
